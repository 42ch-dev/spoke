...
| [`architecture-patterns/fixture-ajv-harness-outside-dist.md`](architecture-patterns/fixture-ajv-harness-outside-dist.md) | architecture-patterns | compound 2026-07-23 (fixtures-conformance) | AJV fixture harness excluded from package dist; ci:typescript gate |
