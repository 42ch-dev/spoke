...
| [`architecture-patterns/rust-spoke-operations-parity.md`](architecture-patterns/rust-spoke-operations-parity.md) | architecture-patterns | compound 2026-07-25 (rust-ops-parity) | Rust `spoke-operations` crate: `SpokeResult` idiom, reject-code parity, typify body wire preservation, crates.io dep version pin |
