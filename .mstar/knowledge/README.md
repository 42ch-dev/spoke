...
| [`architecture-patterns/lockstep-semver-release.md`](architecture-patterns/lockstep-semver-release.md) | architecture-patterns | compound 2026-07-25 (version-release) | Lockstep assert/bump, CHANGELOG via git-cliff, annotated `vX.Y.Z` tags, `release.yml` fail-closed + npm/crates.io on stable tags; SemVer ≠ `schema_version` |
