...
| [`architecture-patterns/lockstep-semver-release.md`](architecture-patterns/lockstep-semver-release.md) | architecture-patterns | compound 2026-07-25 (version-release) | Lockstep assert/bump, annotated `vX.Y.Z` tags, `release.yml` fail-closed; no registry publish; SemVer ≠ `schema_version` |
