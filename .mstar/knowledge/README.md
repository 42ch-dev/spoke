...
| [`architecture-patterns/knowledge-entry-timeline-event-vocabulary.md`](architecture-patterns/knowledge-entry-timeline-event-vocabulary.md) | architecture-patterns | compound 2026-07-23 (terminology) | KnowledgeEntry + TimelineEvent wire names; dual-concern vs `block_type: "event"`; SPOKE = Knowledge Engine |
