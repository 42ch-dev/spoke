...
| **spoke-connect uniffi bindings** | Binding matrix by product priority: **C#, Go, Python, Swift, Kotlin — C# first when bindgen clears**. Swift sync-core skeleton already landed | **C# deferred:** `uniffi-bindgen-cs` targets uniffi 0.31 vs repo pin 0.32 ([connect-csharp-bindgen-deferred.md](specs/connect-csharp-bindgen-deferred.md)). Revisit on bindgen-cs targeting 0.32+ |
