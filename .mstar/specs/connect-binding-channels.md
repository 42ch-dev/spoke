...
| Distribution | **Git-based** — the committed headers and platform natives resolve together from the repository tag `vX.Y.Z`, the resolution model the Go and SPM channels use; the channel has no registry feed and no Release archive assets |
