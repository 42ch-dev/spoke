...
| [`spoke-protocol-layers.md`](spoke-protocol-layers.md) | L0–L8 layer model; optional flags (`l5-fork`, `narrative-modules`, `l5-mind`); L5 Temporal — `l5-mind` = `MindState` temporal records (companion wire-slice) |
