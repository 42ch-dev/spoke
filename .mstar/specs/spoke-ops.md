...
- [x] Optional `project` / `compute` ops documented when `l2-computable` ships (4 optional ops schemas; protocol inventory **31** — see [`spoke-protocol.md`](spoke-protocol.md) §Schema file count)
