...
// is a session-cache face, not a D4 serve op, and stays out), every method
// Result<String, FfiError> over JSON-string boundaries.
#[uniffi::export(callback_interface)]
