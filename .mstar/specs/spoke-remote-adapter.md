...
- [ ] FFI parity mirror statement recorded in the TS↔Rust parity section above (the FFI surface mirrors the locked D13–D16 library faces; native bindings consume only the FFI surface; sync block-on-async per D12)
