...
const zhSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: '远程工具', link: '/zh/how-to/connect-remote-tools' },
      { text: '跨多个对等节点路由', link: '/zh/how-to/multi-peer-routing' },
      { text: '原生绑定', link: '/zh/how-to/connect-native-bindings' },
      { text: 'C 与 C++（C ABI）', link: '/zh/how-to/connect-cpp-binding' },
