...
export const SCHEMA_IDS = {
  ...
  mindState: "https://spoke42.invalid/schemas/data/mind-state.schema.json",
  ...
  extractRequest: "https://spoke42.invalid/schemas/ops/extract-request.schema.json",
  extractResponse: "https://spoke42.invalid/schemas/ops/extract-response.schema.json",
...
export const FIXTURE_SCHEMA_MAP: Record<string, string> = {
  ...
  "evt_tw_hidden_transfer.json": SCHEMA_IDS.timelineEvent,
  "mind_tw_bo_pre_transfer.json": SCHEMA_IDS.mindState,
  "mind_tw_bo_post_transfer.json": SCHEMA_IDS.mindState,
  ...
  "op_tw_extract_request.json": SCHEMA_IDS.extractRequest,
  "op_tw_extract_response.json": SCHEMA_IDS.extractResponse,
  "op_tw_extract_error_response.json": SCHEMA_IDS.extractResponse,
  ...
  "host_tw_extractor.json": SCHEMA_IDS.hostCapabilityManifest,
