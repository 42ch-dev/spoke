...
//   - src/remote/index.ts   -> dist/remote/index.{mjs,js} + .d.{mts,ts}  (opt-in RemoteAdapter subpath;
//     imports `@42ch/spoke-operations`, which the default entries never resolve)
