...
export const SpokeRejectCode = {
  ...
  INVALID_KEYBLOCK_STATUS: "INVALID_KEYBLOCK_STATUS",
  INVALID_KEYBLOCK_STATUS_TRANSITION: "INVALID_KEYBLOCK_STATUS_TRANSITION",
  DUPLICATE_ACTIVE_KEYBLOCK: "DUPLICATE_ACTIVE_KEYBLOCK",
  KEYBLOCK_NOT_FOUND: "KEYBLOCK_NOT_FOUND",
  KEYBLOCK_ALREADY_EXISTS: "KEYBLOCK_ALREADY_EXISTS",
  KEYBLOCK_TERMINAL_STATUS: "KEYBLOCK_TERMINAL_STATUS",
  RELATION_SELF_EDGE: "RELATION_SELF_EDGE",
  RELATION_MISSING_ENDPOINT: "RELATION_MISSING_ENDPOINT",
} as const;
